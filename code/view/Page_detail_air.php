<?php ob_start(); ?>
	<div class="details">
		<h1 class="first_details_info"><a href="/Hackathon/code"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i></a> Qualité de l'air</h1>
		
		<section class="rgba-green">
			<h3 class="green"><img src="/Hackathon/code/img/wind_green.png" class="green">Vert</h3>
			<span>
		...
		<section class="rgba-orange">
			<h3 class="orange"><img src="/Hackathon/code/img/wind_orange.png" class="orange">Orange</h3>
			<span>
		...
		<section class="rgba-red last">
			<h3 class="red"><img src="/Hackathon/code/img/wind_red.png" class="red">Rouge</h3>
			<span>
